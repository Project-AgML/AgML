...
#---------------- CAMERA PARAMETERS --------------------
hdg.camera_param_ranges['camera_position'] = [[0,-4,1],[1,-4,1],[2,-4,1]]
...
#     # ---------------- CANOPY PARAMETERS -------------------
hdg.canopy_param_ranges['VSPGrapevine']['plant_count'] = [[5, 5],[1, 1]]
hdg.canopy_param_ranges['VSPGrapevine']['plant_height'] = [[1, 2]]
hdg.canopy_param_ranges['VSPGrapevine']['canopy_origin'] = [[0, 0, 0]]
...
hdg.generate_data(n_imgs=1, canopy_type='VSPGrapevine', annotation_type = 'semantic', simulation_type='rgb', label_elements='leaves, branches', output_directory='/home/dariojavo/Documents/UCDavis/AgML-dev') #object instance