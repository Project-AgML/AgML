...
def annotate_semantic_segmentation(image, mask=None, alpha=0.3, border=True):
...
def show_image_and_overlaid_mask(image, mask=None, alpha=0.3, border=True, **kwargs):
...
def show_image_and_mask(image, mask=None, **kwargs):
...
def show_semantic_segmentation_truth_and_prediction(
    image, real_mask=None, predicted_mask=None, alpha=0.3, border=True, **kwargs
):
