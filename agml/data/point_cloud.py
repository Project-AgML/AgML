...
class PointCloud(object):
    ...
    def _infer_structure(row, pointcloud_structure):
        ...
        if pointcloud_structure is not None:
            ...
            if not all(i in PointCloud.VALID_STRUCTURES for i in pointcloud_structure):
                raise ValueError(
                    f"Invalid point cloud structure {pointcloud_structure}, "
        ...
        if any(i in pointcloud_structure for i in ["r", "g", "b"]) and not all(
            i in pointcloud_structure for i in ["r", "g", "b"]
        ):
    ...
    def _build_3d_object(self):
        ...
        try:
            ...
            log(
                "Open3D is not installed. If you want to have high-res point cloud "
