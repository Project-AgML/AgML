...
def build_loader(dataset: Union[List[str], str],
                 batch_size: int = 4,
                 augmentations: Any = None) -> agml.data.AgMLDataLoader:
    ...
    # Apply the transforms to the loader.
    loader.transform(dual_transform = _pre_prepare_for_efficientdet)
    if augmentations is not None:
        loader.transform(dual_transform = augmentations)
    loader.transform(dual_transform = _post_prepare_for_efficientdet)
